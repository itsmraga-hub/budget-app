...
class BudgetCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget_category" do
    assert_difference("BudgetCategory.count") do
      post budget_categories_url, params: { budget_category: { icon: @budget_category.icon, name: @budget_category.name } }
    end
  ...
  test "should update budget_category" do
    patch budget_category_url(@budget_category), params: { budget_category: { icon: @budget_category.icon, name: @budget_category.name } }
